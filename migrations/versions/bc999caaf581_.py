...
Revision ID: bc999caaf581
Revises: 762402052503
Create Date: 2021-03-30 18:10:37.904559
...
def upgrade():
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('planet_name', sa.String(length=10), nullable=True),
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('vehicle_name', sa.String(length=10), nullable=True),
    sa.Column('model', sa.Integer(), nullable=True),
    sa.Column('passenger', sa.Integer(), nullable=True),
    sa.Column('consumable', sa.String(length=10), nullable=True),
    sa.Column('starship_class', sa.String(length=10), nullable=True),
